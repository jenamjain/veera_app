...
const API_BASE_URL = __DEV__ ? 'http://192.168.1.12:8080/api' : 'http://localhost:8080/api';
const SOS_API_BASE_URL = __DEV__ ? 'http://192.168.1.12:3000' : 'http://localhost:3000';
